                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="project_" class="from-label">Project Name</label>
                                    <input type="text" name="name" id="project_" class="form-control text-white" placeholder="Project Name">
                                </div>
                            </div>
...
<?php endif; ?><?php /**PATH D:\html-css-js\Laravel-Projects\Not_Yet\portfolio\resources\views/pages/products/index.blade.php ENDPATH**/ ?>