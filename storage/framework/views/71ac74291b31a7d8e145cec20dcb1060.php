<?php $__env->startSection('title', 'Hide Menu On Scroll'); ?>
    ...
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo e(route('layout_light')); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\starter-kit\resources\views/starter_kit/hide_menu_on_scroll.blade.php ENDPATH**/ ?>