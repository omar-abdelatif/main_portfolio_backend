 ...
 <div class="sidebar-wrapper" data-sidebar-layout="stroke-svg">
     <div>
         <div class="logo-wrapper"><a href="<?php echo e(route('layout_light')); ?>"><img class="img-fluid for-light"
         ...
         <div class="logo-icon-wrapper"><a href="<?php echo e(route('layout_light')); ?>"><img class="img-fluid"
                         ...
                         <ul class="sidebar-submenu">
                             <li><a class="submenu-title" href="#">color version<span class="sub-arrow"><i
                                 ...
                                 <ul class="sidebar-submenu submenu-content">
                                     <li><a href="<?php echo e(route('layout_light')); ?>">Layout Light</a></li>
                                     <li><a href="<?php echo e(route('layout_dark')); ?>">Layout Dark</a></li>
                                 </ul>
                             </li>
                             <li> <a class="submenu-title" href="#">Page layout<span class="sub-arrow"><i
                                 ...
                                 <ul class="sidebar-submenu submenu-content">
                                     ...
                                     <li><a href="<?php echo e(route('rtl_layout')); ?>">RTL</a></li>
                                 </ul>
                             </li>
                             <li><a href="<?php echo e(route('hide_menu_on_scroll')); ?>"><span>Hide menu on Scroll</span></a></li>
 ...
 <!-- Page Sidebar Ends-->
<?php /**PATH D:\starter-kit\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>