...
<?php $component->withAttributes([]); ?>
    ...
    <div class="table-responsive">
        <div class="card">
            <div class="card-body">
                <table id="category-table" class="table table-striped align-middle" data-page-length="25">
                    <thead>
                        <tr>
                        ...
                        <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit_cat_<?php echo e($cat->id); ?>">
                                        <i data-feather="edit"></i>
                                    </button>
                                    <div class="modal fade" id="edit_cat_<?php echo e($cat->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Update Category <?php echo e($cat->name); ?></h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="<?php echo e(route('categories.update')); ?>" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="catname" class="from-label">Category Name</label>
                                                            <input type="text" name="name" id="catname" class="form-control text-white" value="<?php echo e($cat->name); ?>" placeholder="Category Name" value="<?php echo e($cat->name); ?>">
                                                        </div>
                                                        <div class="modal-footer mt-3">
                                                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
...
<?php endif; ?>
                                    ...
                                    <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete_cat_<?php echo e($cat->id); ?>">
                                        <i data-feather="trash-2"></i>
                                    </button>
                                    <div class="modal fade" id="delete_cat_<?php echo e($cat->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Delete Category <?php echo e($cat->name); ?></h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="<?php echo e(route('categories.delete', $cat->id)); ?>" method="get">
                                                        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH D:\html-css-js\Laravel-Projects\Not_Yet\portfolio\resources\views/pages/categories/index.blade.php ENDPATH**/ ?>